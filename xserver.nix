    ...
    displayManager = {
      ...
      session = [ {
        ...
        start = ''
          ...
          # Set desktop background to a random greyscale fractal generated by ImageMagick.
          mktemp --suffix=.png \
            | xargs -I'{}' sh -c 'convert -size 1440x900 -seed $RANDOM plasma:black -colorspace Gray {} \
            && ${pkgs.pcmanfm.out}/bin/pcmanfm --set-wallpaper={}'
